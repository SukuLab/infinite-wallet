...
export default new Vuex.Store({
  ...
  mutations: {
    ...
    setSelectedNetwork(state, x) {
      state.selectedNetwork = x;
    },
    setBalance(state, x) {
      state.balance = x;
    },
    setActiveAccount(state, x) {
      state.activeAccount = x;
    },
  ...
  actions: {
    ...
    setSelectedNetwork({ commit }, x) {
      commit("setSelectedNetwork", x);
    },
    setBalance({ commit }, x) {
      commit("setBalance", x);
    },
    setActiveAccount({ commit }, x) {
      commit("setActiveAccount", x);
    },
